...
def mydonations():
    ...
    logo=loadImage('Logoo.png')
    textSize(50)
    text("My Donations", 170, 150)
    rect(30, 320, 250, 430)
    textSize(25)
    text("DONATIONS", 70, 300)
    text("TOP DONATION", 370, 300)
    rect(350, 320, 250, 100)
    image(x, 10, 10, width/15, height/20)
    image(logo,0,800)
    fill(0)
    textSize(20)
    text('Peter Parker -  $3,000',40,360)
    text('Clark Kent -  $10,000',40,420)
    text('Bary Allen -  $1,500',40,480)
    text('Brian Brown -  $600',40,540)
    text('Miley Cyrus -  $2,000',40,600)
    text('Katy Perry -  $3,600',40,660)
    text('$10,000',370,390)
    textSize(15)
    fill(150)
    text('January 20,2021',150,390)
    text('November 26,2020',135,450)
    text('October 13,2020',150,510)
    text('June 30,2020',170,570)
    text('November 26,2020',450,410)
    text('May 15,2020',170,630)
    text('Febuary 29,2020',150,690)
    textSize(35)
    fill(0)
    text('Clark Kent',370,360)
